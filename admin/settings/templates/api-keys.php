	...
	<form method="post" action="options.php">
		...
		<table class="form-table">
			<tr>
                ...
                <td class="forminp">
                    <fieldset>
                        ...
                        <label class="switch">
                            <input type="checkbox" id="shipbubble_mode" name="shipbubble_mode" value="1" class="switch-checkbox" <?php checked(shipbubble_is_live_mode()); ?>>
			...
			<tr>
				...
				<td><input type="text" name="shipbubble_live_api_key" id="shipbubble_live_api_key" class="regular-text" value="<?php echo esc_attr($live_key); ?>"></td>
			</tr>
			<tr>
				<th scope="row"><label for="shipbubble_test_api_key">Test API Key</label></th>
				<td><input type="text" name="shipbubble_test_api_key" id="shipbubble_test_api_key" class="regular-text" value="<?php echo esc_attr($test_key); ?>"></td>
			</tr>
		</table>
		<?php submit_button(); ?>
	</form>
