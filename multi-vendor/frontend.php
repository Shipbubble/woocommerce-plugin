...
//	add_action('dokan_store_profile_saved', 'add_shipbubble_multivendor_form', 10, 2);
    ...
    add_action('dokan_store_profile_saved', 'handle_saved_profile', 10, 2);

    function handle_saved_profile($store_id, $dokan_settings) {
	...
	if ($revalidate_address) {
        ...
        error_log(print_r($live_key_response, true));
